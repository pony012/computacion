<?php
	...
	if ($_GET['m'] == 'e') {
		if (!isset ($_GET['id']) || $_GET['id'] < 1) {
			...
			$query = sprintf ("SELECT Descripcion, Id, Exclusiva, UNIX_TIMESTAMP (Apertura) AS Apertura, UNIX_TIMESTAMP (Cierre) AS Cierre FROM Evaluaciones WHERE Id='%s' LIMIT 1", $_GET['id']);
